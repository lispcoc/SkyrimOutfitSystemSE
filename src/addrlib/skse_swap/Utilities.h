...
#define DEFINE_MEMBER_FN_LONG(className, functionName, retnType, address, ...)		\
	...
	{																				\
		...
		_address = runtime_offset_lookup(address) + RelocationManager::s_baseAddr;							\
...
#define DEFINE_MEMBER_FN_0(fnName, retnType, addr)						\
	...
	const static uintptr_t address = runtime_offset_lookup(addr) + RelocationManager::s_baseAddr;	\
